...
const replaceVal=(tempVal,orgVal)=>{
    ...
    temperature=temperature.replace("{%tempfeel%}",(orgVal.main.feels_like-273.15).toFixed(2));
...
const server=http.createServer((req,res)=>{
    if(req.url=="/"){
        requests("https://api.openweathermap.org/data/2.5/weather?q=anand&appid=7a31b8a095fc416cd287ae6377e228ee")
        .on("data",(chunk)=>{
